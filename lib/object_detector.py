...
from lib.pytorch_misc import enumerate_by_image, gather_nd
...
class Result(object):
    ...
    def __init__(self, od_obj_dists=None, rm_obj_dists=None,
                 ...
                 im_inds=None, fmap=None, rel_dists=None, rel_inds=None,
                 gat_obj_dist=None, gat_obj_preds=None, rel_rep=None, pooled_obj_fmap=None,
...
class ObjectDetector(nn.Module):
    ...
    def __init__(self, classes, mode='rpntrain', num_gpus=1, nms_filter_duplicates=True,
                 max_per_img=64, use_resnet=False, thresh=0.05, get_gt_pred=False):
        """
    ...
    def gt_boxes(self, fmap, im_sizes, image_offset, gt_boxes=None, gt_classes=None, gt_rels=None,
        ...
        if (gt_rels is not None and self.training) or self.get_gt_pred:
...
def load_vgg(use_dropout=True, use_relu=True, use_linear=True, pretrained=False):
